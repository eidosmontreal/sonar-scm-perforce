...
[![Build Status](https://api.travis-ci.com/eidosmontreal/sonar-scm-perforce.svg?branch=master)](https://app.travis-ci.com/github/eidosmontreal/sonar-scm-perforce)
